...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ...
     web-beautify          ;; format buffer to be beautiful
     (html   :variables    ;; add support for html and css
